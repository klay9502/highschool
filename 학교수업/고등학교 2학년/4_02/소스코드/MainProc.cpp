...
int GameRun()
{
	...
	StretchBlt(hMemoryDC, 0, 0, 1024, 768, hImageDC1, 0, 0, 1280, 800, SRCCOPY);
	TransparentBlt(hMemoryDC, 0 + ptMouse.x, 0 + ptMouse.y, 137, 137, hImageDC2, (nCount * 130), 0, 137 , 137, RGB(255, 255, 255));
